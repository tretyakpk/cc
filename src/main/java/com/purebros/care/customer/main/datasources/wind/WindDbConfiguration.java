...
public class WindDbConfiguration {
    ...
    public DataSource windDataSource() {
        ...
        System.out.println("<<<<<< Connection to wind database >>>>>> "
            + "class: " + env.getProperty("wind.datasource.driver-class-name")
            + "; url: " + env.getProperty("wind.datasource.url")
            + "; username: " + env.getProperty("wind.datasource.username")
            + "; password: " + env.getProperty("wind.datasource.password")
        );

        DriverManagerDataSource dataSource = new DriverManagerDataSource();
        dataSource.setDriverClassName(env.getProperty("wind.datasource.driver-class-name"));
        dataSource.setUrl(     env.getProperty("wind.datasource.url"));
        dataSource.setUsername(env.getProperty("wind.datasource.username"));
        dataSource.setPassword(env.getProperty("wind.datasource.password"));
